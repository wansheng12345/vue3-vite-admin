...
const pieData = ref([
  { value: 1048, name: "Option1" },
  { value: 735, name: "Option2" },
  { value: 580, name: "Option3" },
  { value: 484, name: "Option4" },
  { value: 300, name: "Option5" },
]);
    ...
    series: [
      {
        ...
        type: "pie",
        radius: ["50%", "65%"],
        itemStyle: { borderRadius: 0,opacity: 0.7, },
        emphasis: { label: { show: true }, scale: true, scaleSize: 10 },
        label: { show: false, position: "center", fontSize: 26, color: "#fff" },
        data: pieData.value,
      },
    ],
  };
