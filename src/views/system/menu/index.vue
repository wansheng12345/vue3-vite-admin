...
const List=ref([
    {
      ...
      orderNum: 1,
      status: "0",
      createTime: "2023-02-03 11:11:36",
      component: "",
      perms: "",
      menuId: 1,
      children: [
        {
          ...
          children:[
            {
              menuName: "用户查询",
              createTime: "2023-02-03 11:11:42",
              menuId: 101,
              icon: "#",
              orderNum:1,
              status: "1",
      ...
      children:[
         {
          ...
          perms: "HealthManagement:HighFrequency:list",
          menuId: 20,
        },
        {
          menuName: "故障工单",
          ...
          status: "1",
          createTime: "2023-02-03 11:11:36",
          component: "HealthManagement/TroubleOrder/index",
          perms: "HealthManagement:TroubleOrder:list",
          menuId: 21,
        },
      ]
    },
